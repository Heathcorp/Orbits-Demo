function Orbiter (initPos, initVel, radius) {
    ...
    this.EarthCollisionCheck = function() {
        ...
        let radii = this.rad + earthMass/6;
    ...
    this.Fragment = function () {
        ...
        nextOrbiters.push(new Orbiter(p5.Vector.add(this.pos, createVector(-this.rad/2, -this.rad/2)), p5.Vector.mult(this.vel, 1), this.rad/2));
        nextOrbiters.push(new Orbiter(p5.Vector.add(this.pos, createVector(this.rad/2, this.rad/2)), p5.Vector.mult(this.vel, 1), this.rad/2));
